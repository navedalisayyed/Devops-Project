...
🔹 Even though the defaults are already set in the app, we explicitly define them in the ConfigMap. This demonstrates Configuration as Code — making all runtime configuration visible and manageable via Kubernetes manifests.
